...
script_name_share="awg_repair.sh"
script_full_path_share="${script_path_share}/${script_name_share}"

script_launcher_name_share="awg_repair_launcher.sh"
script_launcher_full_path_share="${script_path_share}/${script_launcher_name_share}"

script_path_local="/root/awg_repair"
script_name_local="awg_repair.sh"
script_full_path_local="${script_path_local}/${script_name_local}"

script_launcher_name_local="awg_repair_launcher.sh"
